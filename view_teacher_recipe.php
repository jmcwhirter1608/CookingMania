...
<body>
    ...
    <hr />
    <h1 align="center">My Recipes List</h1>
    ...
    $result = mysqli_query($connection, "SELECT * FROM Recipes WHERE User_ID=$User_ID");
    $num_recipes = mysqli_num_rows($result);

    if( $num_recipes == 0){
      Print '<h1> No recipes exists for you. Create one! </h1>';
    }
    else {
